...
export const appConfig: AppConfig = {
  ...
  // data volume dir, for save sqlite.db & customicons
  dataVolumeDir,

  // Custom icons dir
  // Recommended production environment designated catalog in non-project catalog
  // e.g: path.resolve('../data_volume/icons')
